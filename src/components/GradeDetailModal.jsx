...
function GradeDetailModal({ grade, isOpen, onClose }) {
  ...
  const gradeDetail = {
    ...
    allSessions: [
      { session: 1, myScore: 85, classAverage: 78, date: '2024-01-15' },
      { session: 2, myScore: 92, classAverage: 82, date: '2024-01-22' },
      { session: 3, myScore: 78, classAverage: 75, date: '2024-01-29' },
      { session: 4, myScore: 88, classAverage: 80, date: '2024-02-05' },
      { session: 5, myScore: 95, classAverage: 85, date: '2024-02-12' },
      { session: 6, myScore: 85, classAverage: 83, date: '2024-02-19' },
      { session: 7, myScore: 87, classAverage: 81, date: '2024-02-26' },
      { session: 8, myScore: 96, classAverage: 86, date: '2024-03-05' },
    ],
    // 과제 성적 데이터
    assignments: [
      { session: 1, grade: 'A', date: '2024-01-15' },
      { session: 2, grade: 'A', date: '2024-01-22' },
      { session: 3, grade: 'B', date: '2024-01-29' },
      { session: 4, grade: 'B', date: '2024-02-05' },
      { session: 5, grade: 'A', date: '2024-02-12' },
      { session: 6, grade: 'A', date: '2024-02-19' },
      { session: 7, grade: 'B', date: '2024-02-26' },
      { session: 8, grade: 'A', date: '2024-03-05' },
    ],
    // 출석 데이터
    attendance: {
      totalSessions: 8,
      ...
      attendanceRate: 87.5,
      sessions: [
        { session: 1, attended: true, date: '2024-01-15' },
        { session: 2, attended: true, date: '2024-01-22' },
        { session: 3, attended: true, date: '2024-01-29' },
        { session: 4, attended: true, date: '2024-02-05' },
        { session: 5, attended: true, date: '2024-02-12' },
        { session: 6, attended: false, date: '2024-02-19' },
        { session: 7, attended: true, date: '2024-02-26' },
        { session: 8, attended: true, date: '2024-03-05' },
      ],
    },
    // 단원별 오답분포 데이터
    wrongUnits: [
  ...
  const scoreTrendData = {
    labels: gradeDetail.allSessions.map(s => `${s.session}회차`),
    datasets: [
      {
        label: '반 평균',
        data: gradeDetail.allSessions.map(s => s.classAverage),
        borderColor: '#10b981',
      ...
      {
        label: '내 점수',
        data: gradeDetail.allSessions.map(s => s.myScore),
                ...
                <div className='attendance-assignment-content'>
                  <div className='attendance-section'>
                    ...
                    <div className='attendance-summary'>
                      <div className='attendance-circle'>
                        <span className='attendance-number'>
                          {gradeDetail.attendance.attendedSessions}
                        </span>
                        <span className='attendance-total'>
                          / {gradeDetail.attendance.totalSessions}
                        </span>
                      </div>
                    ...
                    <div className='attendance-list'>
                      {gradeDetail.attendance.sessions.map(session => (
                        <div
                          key={session.session}
                          className={`attendance-item ${session.attended ? 'present' : 'absent'}`}
                        >
